                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted">
                                                            <?php echo e(ucfirst($sale->user->role->name ?? 'kasir')); ?>
                                                ...
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $sale)): ?>
                                                        ...
                                                        <?php if($isLunas && auth()->user()->role->name === 'admin'): ?>
                                                            ...
                                                            <a href="<?php echo e(route('admin.penjualan.show', $sale->id)); ?>" class="btn btn-sm btn-primary"
                                                                title="Detail struk">
                                                        ...
                                                        <?php elseif(!$isLunas): ?>
                                                            ...
                                                            <a href="<?php echo e(route('admin.penjualan.edit', $sale->id)); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $sale)): ?>
                                                        ...
                                                        <form action="<?php echo e(route('admin.penjualan.destroy', $sale->id)); ?>" method="POST"
                                                            class="d-inline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_enay4\resources\views/penjualan/index.blade.php ENDPATH**/ ?>