...
<body>
	<main class="receipt">
			...
			<?php $__currentLoopData = $sale->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="item">
					<div class="item-name">
						...
						<div class="subtext"><?php echo e($item->kuantitas); ?> x Rp
							<?php echo e(number_format($item->harga_satuan, 0, ',', '.')); ?></div>
					</div>
		...
		<div class="row">
			...
			<span>Rp <?php echo e(number_format($sale->uang_dibayar ?? $sale->total_pembayaran, 0, ',', '.')); ?></span>
		</div>
		<div class="row">
			<strong>Kembalian</strong>
			<strong>Rp <?php echo e(number_format($sale->kembalian ?? 0, 0, ',', '.')); ?></strong>
		</div>
		<footer class="center">
...
</html><?php /**PATH C:\laragon\www\pos_enay4\resources\views/penjualan/struk.blade.php ENDPATH**/ ?>