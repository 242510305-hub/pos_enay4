    ...
    <div class="container py-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            ...
            <?php if(auth()->user()->role?->name === 'admin'): ?>
                <a href="<?php echo e(route('admin.jenis.create')); ?>" class="btn btn-primary rounded-pill px-4 shadow-sm">
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <?php if(auth()->user()->role?->name === 'admin'): ?>
                                            ...
                                            <form action="<?php echo e(route('admin.jenis.destroy', $item->id)); ?>" method="POST"
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="text-center py-5">
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <a href="<?php echo e(route('admin.jenis.create')); ?>" class="btn btn-primary rounded-pill px-4">
